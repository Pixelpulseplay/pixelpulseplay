  ...
  return (
    <main className="ppp-home">
      {activePromotions.length > 0 && (
        <PromotionModal promotionPopup={promotionPopup} promotions={activePromotions} />
      )}
      ...
      {attractionsData?.[0]?.children?.length > 0 && (
        <section className="ppp-section ppp-blog">
          <div className="aero-max-container">
            ...
            <p className="ppp-section__sub">
              Planning tips, attraction ideas, and the latest updates to help you make the most of your next visit.
            </p>
